"""Punto de entrada interactivo para el sistema restaurante_app.

Cumple los requisitos de la semana 9: utiliza list, tuple, dict y set
con responsabilidades claras. Mantiene la gestión de colecciones dentro
del servicio Restaurante.
"""
...
# Asegurar que el directorio padre de `restaurante_app` esté en sys.path para
# que las importaciones absolutas `from restaurante_app...` funcionen siempre,
...
def main() -> None:
    ...
    # Diccionario: mapear opción -> función (relación clave->valor clara)
    ...
    def mostrar_categorias() -> None:
        # set: obtener categorías únicas sin duplicados
    ...
    # Poblamos el diccionario de acciones (clave -> función)
    actions.update({
