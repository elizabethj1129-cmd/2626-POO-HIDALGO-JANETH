...
class Restaurante:
    ...
    def __init__(self) -> None:
        ...
        # Estructuras auxiliares (índices en memoria) para mejorar rendimiento
    ...
    def _load_products(self) -> None:
        ...
        for item in raw:
            try:
                ...
                if p.codigo not in self._indice_productos:
                    self._productos.append(p)
                    self._indice_productos[p.codigo] = p
    ...
    def _load_users(self) -> None:
        ...
        for item in raw:
            try:
                ...
                if u.identificacion not in self._indice_usuarios:
                    self._usuarios.append(u)
                    self._indice_usuarios[u.identificacion] = u
            except KeyError as e:
        ...
        for item in raw:
            try:
                ...
                if not any(x.usuario_id == v.usuario_id and x.producto_codigo == v.producto_codigo
                    ...
                    if v.usuario_id not in self._ventas_por_usuario:
                        self._ventas_por_usuario[v.usuario_id] = []
