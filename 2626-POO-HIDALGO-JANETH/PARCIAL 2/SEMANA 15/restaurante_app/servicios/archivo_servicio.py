...
class ArchivoServicio:
    ...
    Maneja persistencia para productos y usuarios.
    """
    ...
    def cargar_productos(path: Path) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            print("Error: el archivo de productos contiene JSON inválido.")
            return []
    ...
    def cargar_usuarios(path: Path) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            print("Error: el archivo de usuarios contiene JSON inválido.")
            return []
        except PermissionError:
    ...
    def cargar_ventas(path: Path) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            print("Error: el archivo de ventas contiene JSON inválido.")
            return []
        except PermissionError:
